...
(function (d, k) {
    ...
    d.fn.fullpage = function (c) {
        function y() {
            ...
            ma();
            n.on("load", function () {
                var a = k.location.hash.replace("#", "").split("/"), d = a[0], a = a[1];
        ...
        function ra() {
            ...
            if (!c.autoScrolling || c.scrollBar) {
                ...
                if (!a.hasClass("active") && !a.hasClass("fp-auto-height")) {
                    ...
                    if (k.length)var l = k.data("anchor"), y = k.index();
        ...
        function B(a) {
            ...
            if (c.autoScrolling && !O) {
                a = a || k.event;
                var g = a.wheelDelta || -a.deltaY || -a.detail, f = p.max(-1, p.min(1, g)), e =
                    "undefined" !== typeof a.wheelDeltaX || "undefined" !== typeof a.deltaX, e = p.abs(a.wheelDeltaX) < p.abs(a.wheelDelta) || p.abs(a.deltaX) < p.abs(a.deltaY) || !e;
        ...
        function za() {
            if (!X && !c.lockAnchors) {
                var a = k.location.hash.replace("#", "").split("/"), b = a[0], a = a[1], d = "undefined" === typeof z, f = "undefined" === typeof z && "undefined" === typeof a && !w;
        ...
        function H(a, b) {
            var g = b.position(),
                f = b.index(), e = a.closest(".fp-section"), h = e.index(".fp-section"), k = e.data("anchor"), l = e.find(".fp-slidesNav"), m = ga(b), n = u;
            if (c.onSlideLeave) {
                var y = e.find(".fp-slide.active"), q = y.index(), r;
            ...
            c.css3 ? (g = "translate3d(-" + p.round(g.left) + "px, 0px, 0px)", Aa(a.find(".fp-slidesContainer"), 0 < c.scrollingSpeed).css(Ba(g)), ha = setTimeout(function () {
                t()
            }, c.scrollingSpeed, c.easing)) : a.animate({scrollLeft: p.round(g.left)}, c.scrollingSpeed, c.easing, function () {
                t()
            });
        ...
        function la() {
            var a = c.responsive || c.responsiveWidth, b = c.responsiveHeight, d = a && n.width() < a, f = b && n.height() < b;
        ...
        function ma() {
            var a = d(".fp-section.active"), b = a.find(".fp-slide.active"), c = ga(a), f = ga(b);
            a.index(".fp-section");
            a = String(c);
            b.length && (a = a + "-" + f);
            a = a.replace("/", "-").replace("#", "");
        ...
        var x = d("html, body"), q = d("body"), e = d.fn.fullpage;
        c = d.extend({
            menu: !1,
            anchors: [],
            lockAnchors: !1,
        ...
        e.setAutoScrolling = function (a, b) {
            ...
            c.autoScrolling && !c.scrollBar ? (x.css({
                ...
                "touch-action": "none"
            }), g.length && I(g.position().top)) : (x.css({overflow: "visible", height: "initial"}),
        ...
        e.reBuild = function (a) {
            if (!h.hasClass("fp-destroyed")) {
                ...
                d.isFunction(c.afterReBuild) && !a && c.afterReBuild.call(h)
            }
        };
        ...
        var w = !1, Q = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/),
            R = "ontouchstart"in k || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, h = d(this), r = n.height(), u = !1, Ja = !0, z, fa, v = !0, C = [], O, l = {
                m: {
                    up: !0,
                    down: !0,
                    left: !0,
        ...
        l.k = d.extend(!0, {}, l.m);
        var D = d.extend(!0, {}, c), ja, da, ha, aa, ba, Ka;
        d(this).length && y();
        var X = !1;
        n.on("scroll", ra);
        var G = 0, N = 0, F = 0, M = 0, va = (new Date).getTime();
